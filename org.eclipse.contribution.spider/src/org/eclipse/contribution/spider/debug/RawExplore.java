...
public class RawExplore implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		getSpider().getFigure(RawSubject.create(subject), new Point(20, 20)); // Where ought to be the responsibility of the SpiderView
	}
